...
if $downloadLatest; then
    ...
    wget https://raw.githubusercontent.com/mpw07458/K8S-Deploy-Shell/master/pure-play/drivers/K8S_App_Shell/src/K8S_App_Shell_OS.py?token=ABm6FlaLr_SF7hyXqNnXZEoe1U--YVXfks5bRPsWwA%3D%3D -O K8S_App_Shell_OS.py -q
fi
